...
subroutine view_panair(t)
    ...
    ! Open the file
    write(filename, *) trim(adjustl(t%master_filename))//'_view.panair'
    open(unit = 10, File = filename, action = 'write', iostat = ierror)
    ...
    do iwing=1,t%nrealwings !real wings
        ...
        write(*,*) symmetric, t%wings(iwing)%side
...
subroutine view_write_panair_header(plane, symmetric)
    ...
    write(10, '(I0, T11, I0)') symmetric, 0
    ...
    write(10, '(I0, T11, I0, T21, I0, T31, I0, T41, I0, T51, I0)') 0, 0, 0, 0, 0, 0
    write(10, '(A, T11, A, T21, A, T31, A, T41, A)') '=ipraic', 'nexdgn', 'ioutpr', 'ifmcpr', 'icostp'
    write(10, '(I0, T11, I0, T21, I0, T31, I0, T41, I0)') 0, 0, 1, 0, 0
...
subroutine view_write_panair_network_header(iwing)
    ...
    write(10, "(F10.6)") 2.0  ! Must be a floating-point value...
...
subroutine view_write_panair_wake(network)
    ...
    write(10, "(A)") "=kn"
    write(10, "(F10.6)") 1.0  ! Must be a floating-point value...
    write(10, "(A, T11, A)") "=kt", "matchw"
    write(10, "(I0, T11, I0)") 18, 0
    write(10, "(A, T11, A, T21, A, T31, A)") "=inat", "insd", "xwake", "twake"
    write(10, "(A, T11, I0, T21, I0, T31, I0, T71, A)") network, 1, 10, 0, "wake"
end subroutine
